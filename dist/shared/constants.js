...
export const ERROR_MESSAGES = {
    ...
    BOOKING_CANNOT_COMPLETE_BEFORE_TIME_ENDS: "Booking cannot be marked as completed before it ends.",
    CANCEL_BOOKING_BEFORE_1_HOUR: "Booking cannot be cancelled within 1 hour of the scheduled time.",
    ...
    MEETING_CANNOT_COMPLETE_BEFORE_TIME_ENDS: "Meeting cannot be marked as completed before it ends",
    INVALID_DATES_FOR_MEETING: "Invalid start time or end time for meeting",
    MEETING_CANNOT_SCHEDULE_IN_PAST: "Meeting must be scheduled for a future time.",
