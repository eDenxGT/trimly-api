...
exports.HandleFailurePaymentUseCase = void 0;
...
let HandleFailurePaymentUseCase = class HandleFailurePaymentUseCase {
    ...
    execute(orderId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const booking = yield this._bookingRepository.update({ orderId }, { status });
            if (!booking) {
            ...
            yield this._transactionRepository.update({
                referenceId: booking === null || booking === void 0 ? void 0 : booking.bookingId,
                source: "booking",
            }, {
                status: "failed",
            });
            yield this._sendNotificationByUserUseCase.execute({
                ...
                message: `Your booking is cancelled for ${(0, date_formatter_1.formatDate)(booking.date.toString())} at ${booking.startTime} due to failed payment.`,
            });
        });
    }
};
exports.HandleFailurePaymentUseCase = HandleFailurePaymentUseCase;
exports.HandleFailurePaymentUseCase = HandleFailurePaymentUseCase = __decorate([
