...
let SendCancelBookingNotificationUseCase = class SendCancelBookingNotificationUseCase {
...
SendCancelBookingNotificationUseCase = __decorate([
    injectable(),
    __param(0, inject("INotificationRepository")),
    __param(1, inject("INotificationSocketHandler")),
    __metadata("design:paramtypes", [Object, Object])
], SendCancelBookingNotificationUseCase);
export { SendCancelBookingNotificationUseCase };
