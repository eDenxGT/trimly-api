...
const random_password_helper_1 = require("../../shared/utils/random-password.helper");
let GoogleUseCase = class GoogleUseCase {
    ...
    execute(credential, client_id, role) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (role === "barber") {
                throw new custom_error_1.CustomError("Barber Shop accounts cannot be created using Google. Please Register First.", constants_1.HTTP_STATUS.FORBIDDEN);
            }
            const tempPassword = (yield (0, random_password_helper_1.generateRandomPassword)(fullName, email)).trim();
            const userData = {
                fullName,
                role,
                googleId,
            ...
            const newUser = yield this._registerUserUseCase.execute(userData);
            if (!newUser) {
                throw new custom_error_1.CustomError("Registration failed", constants_1.HTTP_STATUS.INTERNAL_SERVER_ERROR);
            }
            this._sendEmailUseCase.execute(email, "Welcome to Trimly! Your Google Registration is Complete 🎉", (0, constants_1.GOOGLE_REGISTRATION_MAIL_CONTENT)(fullName, tempPassword));
            return newUser;
        });
    }
};
...
exports.GoogleUseCase = GoogleUseCase = __decorate([
    ...
    __param(2, (0, tsyringe_1.inject)("IBarberRepository")),
