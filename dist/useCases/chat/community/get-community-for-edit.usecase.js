...
exports.GetCommunityForEditUseCase = void 0;
...
let GetCommunityForEditUseCase = class GetCommunityForEditUseCase {
    ...
    execute(communityId) {
        return __awaiter(this, void 0, void 0, function* () {
            const community = yield this._communityRepository.findOne({ communityId });
            if (!community) {
...
exports.GetCommunityForEditUseCase = GetCommunityForEditUseCase;
exports.GetCommunityForEditUseCase = GetCommunityForEditUseCase = __decorate([
