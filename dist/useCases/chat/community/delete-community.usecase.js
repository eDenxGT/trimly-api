...
let DeleteCommunityUseCase = class DeleteCommunityUseCase {
    constructor(_communityRepository, _communityMessageRepository) {
        this._communityRepository = _communityRepository;
        this._communityMessageRepository = _communityMessageRepository;
    }
    execute(communityId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._communityRepository.delete({ communityId });
            yield this._communityMessageRepository.delete({ communityId });
        });
    }
};
...
exports.DeleteCommunityUseCase = DeleteCommunityUseCase = __decorate([
    ...
    __param(1, (0, tsyringe_1.inject)("ICommunityMessageRepository")),
