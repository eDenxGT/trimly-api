...
exports.UpdateMeetingDetailsUseCase = void 0;
...
let UpdateMeetingDetailsUseCase = class UpdateMeetingDetailsUseCase {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ title, description, startTime, endTime, communityId, meetLink, meetingId, }) {
            ...
            yield this._meetingRoomRepository.update({ meetingId, communityId }, {
                title,
                description,
                startTime,
                endTime,
...
exports.UpdateMeetingDetailsUseCase = UpdateMeetingDetailsUseCase;
exports.UpdateMeetingDetailsUseCase = UpdateMeetingDetailsUseCase = __decorate([
